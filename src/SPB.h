...
int SPB_BandSolver_AddMaterial(SPB_BandSolver *S, const char *name, double epsinf[2]);
int SPB_BandSolver_SetMaterial(SPB_BandSolver *S, const char *name, double epsinf[2]);
